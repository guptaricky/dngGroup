						...
						<div class="table-responsive">
							...
							<thead>
							  <tr>
								...
								<th><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Contact No.</th>
								...
								<th><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Balance Amount</th>
								<th><i class="fa fa-fw fa-edit txt-color-blue hidden-md hidden-sm hidden-xs"></i> Actions</th>
							  </tr>
							</thead>
							<tbody>
							  <?php $sno=0;foreach ($customer_ids as $c):$sno++;
									$customer = $this->Common_model->get_data_by_query_pdo("select * from customers where 1 and cust_id=?",array($c['c_id']));
