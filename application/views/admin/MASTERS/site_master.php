								...
								<div class="row">
									...
									<section class="col col-12">
										<label class="input"> <i class="icon-prepend fa fa-image"></i>
											<input type="text" name="site_banner" id="site_banner" placeholder="Site Banner">
										</label>
									</section>
									<section class="col col-12">
										<label class="input"> <i class="icon-prepend fa fa-user"></i>
...
<script>
		...
		function Addsite(){        
		$(".btn").button('loading');
			$.post('<?php echo base_url('admin/MASTERS/addsite'); ?>', $('#checkout-form').serialize(), function (response) {
				$(".btn").button('reset');
