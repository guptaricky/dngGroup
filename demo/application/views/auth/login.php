...
<!-- Mirrored from 192.241.236.31/themes/preview/smartadmin/1.8.x/ajax/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Nov 2017 10:05:42 GMT -->
<head>
		<meta charset="utf-8">
		<title> FMS</title>
		...
		<link rel="stylesheet" type="text/css" media="screen" href="c<?php echo base_url().'assets/ss/demo.min.css'; ?>">
	...
	<body class="animated fadeInDown" >
		...
		<div id="main" role="main" style="height:100%;background-image:url('<?php //echo base_url().'assets/img/bg/main-bg-2.jpg'?>')">
			...
			<div id="content" class="container">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
						<h1 class="txt-color-red login-header-big" style="font-size:50px">DEMO</h1>
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
						...
						<?php 
						echo form_open("auth/login", array('class' => 'smart-form client-form', 'id' => 'login-form'));?>
								...
								<fieldset>
									...
									<section>
										<label class="input"> <i class="icon-append fa fa-user" style="margin-top:18px"></i>
									...
									<section>
										...
										<label class="input"> <i class="icon-append fa fa-lock" style="margin-top:18px"></i>
