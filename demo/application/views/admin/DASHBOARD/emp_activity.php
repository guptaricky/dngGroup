	...
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark"><i class="fa-fw fa fa-list"></i> Notifications <span> </span></h1>
	</div>
				...
				<div>
					...
					<div class="widget-body no-padding">
						<div class="table-responsive">
							...
							<thead>
							  <tr>
								<th><i class=" text-muted hidden-md hidden-sm hidden-xs"></i> Sl.No.</th>
								<th><i class="fa fa-fw fa-clock text-muted hidden-md hidden-sm hidden-xs"></i> Date / Time</th>
								<th><i class="fa fa-fw fa-user txt-color-blue hidden-md hidden-sm hidden-xs"></i> User</th>
								<th><i class="fa fa-fw fa-edit txt-color-blue hidden-md hidden-sm hidden-xs"></i> Activity</th>
							  </tr>
							</thead>
							<tbody>
							  <?php $sno=0;foreach ($logs as $ft):$sno++;?>
							  <tr align="left">
								<td><?php echo $sno;?>.</td>
