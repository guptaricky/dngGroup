	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<h1 class="page-title txt-color-blueDark" style="float:left;"><i class="fa-fw fa fa-edit"></i> Property Detail <span></span></h1>
		<a class="btn btn-xs btn-danger" href="#" onclick="PrintDiv('wid-id-2');" style="float:right;"> <i class="fa fa-print"></i> Print </a>
	</div>
			...
			<div class="jarviswidget" id="wid-id-2" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						...
						<button type="button" class="btn btn-primary btn-sm no_print" onclick="ShowInstallment(<?php echo $detail['prop_detail_id']; ?>)" id="show_btn_<?php echo $detail['prop_detail_id']; ?>"> Pay Your Installment </button>
						...
						<tr><td colspan="3">
						<div class="col col-12 no_print" id="inst_<?php echo $detail['prop_detail_id']; ?>" style="display:none;">
...
<!-- end widget grid -->
	...
	function GetEmi(detail_id){
		...
		var inst ='';	
		var content ='';	
		content +='<table class="table table-bordered" style="width:100%;"><thead><tr><th>Installment</th><th>Amount</th><th>Date</th><th>Remark</th><th>Action</th></tr></thead><tbody>';			
